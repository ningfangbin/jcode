    ...
    match code {
        ...
        KeyCode::Backspace => {
            if app.cursor_pos > 0 {
                ...
                let drain_start = crate::tui::app::input::file_chip_backspace_start(&app.input, app.cursor_pos, &app.file_chips)
                    .unwrap_or(prev);
                app.remember_input_undo_state();
        ...
        KeyCode::Delete => {
            if app.cursor_pos < app.input.len() {
                ...
                let drain_end = crate::tui::app::input::file_chip_delete_end(&app.input, app.cursor_pos, &app.file_chips)
                    .unwrap_or(next);
                app.remember_input_undo_state();
